...
#Original
#python3 download_FF.py ../data -d DeepFakeDetection_original -c c23 -t videos --server EU2

#DeepFakes
#python3 download_FF.py ../data -d DeepFakeDetection -c c23 -t videos --server EU2
